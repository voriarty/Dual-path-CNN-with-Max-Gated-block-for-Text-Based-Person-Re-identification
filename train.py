...
from function import data_config,optimizer_function,load_checkpoint,lr_scheduler,AverageMeter,save_checkpoint,gradual_warmup,fix_seed
...
def main(network,dataloader,compute_loss, optimizer,  scheduler, start_epoch,args,checkpoint_dir):
    ...
    for epoch in range(start_epoch,args.num_epoches):
        ...
        # 动态纪录数据
        writer.add_scalars('learning_rate', {'learning_rate_1': lr1, "learning_rate_2": lr2, "learning_rate_3": lr3}, epoch)
...
if __name__=='__main__':
    ...
    dataloaders = {x: data_config(args.dir, args.batch_size, x, args.max_length,args.embedding_type, transform=data_transforms[x]) for x in
                   ['train', 'val']}
