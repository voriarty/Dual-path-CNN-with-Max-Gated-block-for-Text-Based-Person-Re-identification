...
class CUHKPEDES_BERT_token(data.Dataset):
    ...
    '''
    #DistilBERT
    # pklname_list = ['BERT_encode/BERT_id_train_120.npz', 'BERT_encode/BERT_id_val_120.npz', 'BERT_encode/BERT_id_test_120.npz']

    #BERT
    pklname_list = ['BERT_encode/BERT_id_train_120_new.npz', 'BERT_encode/BERT_id_val_120_new.npz',
                    'BERT_encode/BERT_id_test_120_new.npz']
